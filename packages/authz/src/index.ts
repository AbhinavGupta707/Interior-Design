...
const permissions: RoleActionMatrix = Object.freeze({
  editor: Object.freeze({
    ...
    "render:artifact:read": true,
    "render:job:cancel": true,
    "render:job:create": true,
    "render:job:read": true,
    "render:job:retry": true,
    "model:read": true,
  ...
  viewer: Object.freeze({
    ...
    "render:artifact:read": true,
    "render:job:cancel": false,
    "render:job:create": false,
    "render:job:read": true,
    "render:job:retry": false,
    "model:read": true,
